 ...
 * @file Forms Plugin
 */
document.write( " <script   language= 'javascript '   src= 'createIFrame.js '> </script> "); 
...
CKEDITOR.plugins.add( 'forms',
{
	init : function( editor )
	{
		...
		//	editor.addCommand( commandName, new CKEDITOR.dialogCommand( commandName ) );
			editor.addCommand(commandName,dialogFile);
	...
	//	addButtonCommand( 'Radio',			'radio',		dialogPath + 'radio.js' );
		addButtonCommand( 'TextField',		'textfield',	htmlEditorText("1",editor) );
		addButtonCommand( 'Textarea',		'textarea',	htmlEditorText("1",editor));
		addButtonCommand( 'Select',			'select',		htmlEditorText("1",editor));
